"""
scrapers/citi.py — Citi Career Scraper

Utilise le endpoint Workday CXS (citi.wd5.myworkdayjobs.com).
"""
...
_API_URL  = "https://citi.wd5.myworkdayjobs.com/wday/cxs/citi/2/jobs"
_BASE_URL = "https://citi.wd5.myworkdayjobs.com/en-US/2"
_LIMIT    = 20
...
def scrape() -> list[dict]:
    ...
    for kw in _KEYWORDS:
        offset = 0
        while offset < 400:  # Max 400 offres par mot-clé pour éviter un infinite loop
